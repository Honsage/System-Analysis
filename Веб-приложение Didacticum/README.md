...
В данном документе представлены диаграмма и схема для устаревшего проекта платформы. Актуальный проект подобной платформы расположен в директории "Веб-платформа Doceum". Помимо проекта для данной платформы разработан дизайн интерфейса, ознакомиться с которым можно в соответствующем разделе данного документа.
